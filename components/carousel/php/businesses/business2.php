<?php 
 ...
 //   include('inJacksonville.php');
   ...
   include('../apiRequests/iJDetails2.php');
...
// LOCATION
   ...
   $latitude = $responseArray->businesses[2]->coordinates->latitude;
   $longitude = $responseArray->businesses[2]->coordinates->longitude; 
...
//business address
if(isset($responseArray->businesses[2]->location->display_address[0])){
    $addressZero = $responseArray->businesses[2]->location->display_address[0];
}else{
    $addressZero = "This business has does not have an address.";
}

if(isset($responseArray->businesses[2]->location->display_address[1])){
   $addressOne = $responseArray->businesses[2]->location->display_address[1];
}else{
    $addressOne = "";
}

//phone number
$phone = $responseArray->businesses[2]->display_phone;


//review count
if(isset($responseArray->businesses[2]->review_count)){
   $reviewCount = $responseArray->businesses[2]->review_count;
}else{
    $reviewCount = "The reviews are not available for this business.";
}

//overall business rating
if(isset($responseArray->businesses[2]->rating)){
  $businessRating = $responseArray->businesses[2]->rating; 
}else{
