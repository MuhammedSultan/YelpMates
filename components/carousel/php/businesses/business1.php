<?php 
 ...
 //   include('inJacksonville.php');
   ...
   include('../apiRequests/iJDetails.php');
...
// LOCATION
   ...
   $latitude = $responseArray->businesses[1]->coordinates->latitude;
   $longitude = $responseArray->businesses[1]->coordinates->longitude; 
...
//business address
if(isset($responseArray->businesses[1]->location->display_address[0])){
    $addressZero = $responseArray->businesses[1]->location->display_address[0];
}else{
    $addressZero = "This business has does not have an address.";
}

if(isset($responseArray->businesses[1]->location->display_address[1])){
   $addressOne = $responseArray->businesses[1]->location->display_address[1];
}else{
    $addressOne = "";
}

//phone number
$phone = $responseArray->businesses[1]->display_phone;

//review count
$reviewCount = $responseArray->businesses[1]->review_count;

//overall business rating
$businessRating = $responseArray->businesses[1]->rating; 
?>
<!DOCTYPE html>
